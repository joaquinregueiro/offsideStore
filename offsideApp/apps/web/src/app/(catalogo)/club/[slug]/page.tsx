...
/**
 * `/club/[slug]` — la pantalla la arma `LandingDeCatalogo`, que es la misma
...
const TIPO = 'club' as const;
const CATALOGO = 'club' as const;
...
export async function generateMetadata({
  ...
  return {
     ...
     * `/buscar?club=<uuid>`, y sin esto los dos compiten por la misma consulta:
     * el buscador elige uno y suele ser el que no queremos.
     */
    alternates: { canonical: `/club/${entrada.slug}` },
    openGraph: {
      type: 'website',
      title: textos.titulo(entrada.nombre),
      description: descripcion,
