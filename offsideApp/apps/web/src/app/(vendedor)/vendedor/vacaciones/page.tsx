  ...
  return (
    <Pantalla>
      <main id="contenido" className={estilos.pagina}>
        ...
        <NavDelVendedor activo="vacaciones" />
            ...
            <Seccion titulo="Qué pasa cuando lo activás">
              <div className={estilos.tarjeta}>
                <ul className={estilos.listaHonesta}>
                  ...
                  <li>
                    <strong>Vuelven solas el día que elijas</strong>, sin que tengas que hacer nada.
                    También podés volver antes.
                  </li>
                  <li>
        ...
        <div className={`${estilos.cierre} sup-2 patron-vivo diagonales-vivas`}>
          <p className={estilos.nota}>
            El modo vacaciones no te exime de las órdenes que ya tenés: lo que se pagó antes hay que
            despacharlo igual, y el plazo de despacho sigue corriendo.
          </p>
        </div>
      </main>
    </Pantalla>
