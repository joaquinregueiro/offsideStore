  ...
  return (
    <Pantalla>
      <main id="contenido" className={estilos.pagina}>
        ...
        <NavDelVendedor activo="reputacion" />
          ...
          <div className={`${estilos.tablero} sup-noche con-grano`}>
            <Cifras
              cifras={[
                ...
                {
                  valor:
                    reputacion.avgDispatchHours === null ? '—' : horas(reputacion.avgDispatchHours),
        ...
        */}
        ...
        >
          {resenias.items.length === 0 ? (
            <EstadoVacio titulo="Todavía no te calificaron" icono={<IconoEstrella tamanio={40} />}>
              <p>
          ...
          <Paginacion
            ...
            hrefDe={(n) => (n === 1 ? '/vendedor/reputacion' : `/vendedor/reputacion?pagina=${n}`)}
          />
        </Seccion>

        <div className={`${estilos.cierre} sup-2 patron-vivo diagonales-vivas`}>
          <p className={estilos.nota}>
            La calificación la deja quien te compró y no se puede borrar ni editar desde acá. Si una
            reseña rompe las reglas, Offside la revisa: responderla es tu herramienta, no la única.
          </p>
        </div>
      </main>
    </Pantalla>
