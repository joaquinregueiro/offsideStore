  ...
  return (
    <Pantalla>
      <main id="contenido" className={estilos.pagina}>
        ...
        <NavDelVendedor activo="preguntas" preguntas={pendientes.length} />
        ...
        <div className={`${estilos.cierre} sup-2 patron-vivo diagonales-vivas`}>
          <p className={estilos.nota}>
            Las respuestas son públicas y no se pueden editar después. Offside no tiene chat privado
            entre comprador y vendedor: todo lo que se acuerde fuera de la plataforma queda fuera de
            la plataforma.
          </p>
        </div>
      </main>
