        ...
        */}
        ...
        <div className={`${estilos.cierre} sup-2 patron-vivo diagonales-vivas`}>
          <p className={estilos.nota}>
            Cada cambio de precio y de condición queda registrado (BR-015). La categoría no se puede
            cambiar: volvería obligatorios atributos que esta publicación no tiene, así que si te
            equivocaste hay que publicar de nuevo.
          </p>
        </div>
      </main>
    </Pantalla>
