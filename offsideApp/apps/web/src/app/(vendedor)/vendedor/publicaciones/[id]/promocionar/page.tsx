    ...
    <Pantalla>
      <PanelDeCuenta user={user} seccion="publicaciones">
        <main id="contenido">
          ...
          {!habilitadas && (
            <Aviso tono="error">
              Las promociones están apagadas en este momento. Cuando vuelvan a habilitarse vas a
              poder promocionar desde acá.
            </Aviso>
          )}
          ...
          */}
            <p className={estilos.bajada}>
              ...
              {precio(
                (
                  BigInt(cotizacion.priceAmount) - BigInt(cotizacion.baseCommissionAmount)
                ).toString(),
                cotizacion.currency,
              )}
            ...
            <div className={estilos.tarjeta}>
              <ul className={estilos.listaHonesta}>
                <li>
                  ...
                  completos. Si se pudiera cortar, cualquiera promocionaría para llevarse las
                  visitas y apagaría la promoción justo antes de vender.
                </li>
                <li>
                  <strong>La comisión agravada se aplica a lo que vendas mientras dure.</strong>{' '}
                  Cada orden congela su comisión al crearse (DEC-030): las ventas anteriores no
                  cambian.
                </li>
                <li>
          ...
          <div className={`${estilos.cierre} sup-2 patron-vivo diagonales-vivas`}>
            <p className={estilos.nota}>
              El multiplicador y la duración los fija Offside desde su configuración y pueden
              cambiar. Lo que se aplica a tu promoción es lo que estaba vigente cuando la activaste:
              queda congelado en la promoción.
            </p>
          </div>
        </main>
      </PanelDeCuenta>
