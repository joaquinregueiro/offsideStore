  ...
  return (
    <Pantalla>
      <main id="contenido" className={estilos.pagina}>
        ...
        {!progreso.autoAssign && (
          <Aviso tono="neutro">
            La asignación automática de niveles está apagada en este momento: alcanzar un umbral no
            cambia tu nivel solo.
          </Aviso>
        )}
        ...
        <div className={`${estilos.tablero} sup-noche con-grano`}>
          <Cifras
            cifras={[
              ...
              {
                valor: progreso.nextTier === null ? '—' : String(progreso.nextTier.remainingSales),
                etiqueta: 'Te faltan',
                detalle:
          ...
          <Seccion titulo="Qué te falta">
            ...
            */}
            ...
            <p className={estilos.bajada}>
              ...
              {progreso.nextTier.description === null ? '.' : `. ${progreso.nextTier.description}`}
            </p>
          </Seccion>
        )}
        ...
        <div className={`${estilos.cierre} sup-2 patron-vivo diagonales-vivas`}>
          <p className={estilos.nota}>
            Sólo cuentan las ventas <strong>completadas</strong>: las canceladas y las que siguen en
            curso no suman. Subir de nivel no cambia lo que ya vendiste, porque cada orden congela
            su comisión al crearse — hoy la tuya es{' '}
