      ...
      <PanelDeCuenta user={user} seccion="cuenta">
        <main id="contenido">
          ...
          */
          ...
          <Seccion
            titulo={declarada ? 'Reemplazar la identificación' : 'Declarar tu identificación'}
          >
            <Formulario
        ...
        */}
          <div className={`${estilos.cierre} sup-2 patron-vivo diagonales-vivas`}>
            <p className={estilos.nota}>
              ...
              Cargar una identificación que no te pertenece es motivo de suspensión. El modelo
              fiscal —qué comprobante corresponde, qué régimen— todavía no está definido y esta
              pantalla no deriva ninguna consecuencia impositiva.
            </p>
          </div>
        </main>
      </PanelDeCuenta>
