...
export default async function MisVentas({
  ...
  const reclamosAbiertos = reclamos.filter((reclamo) => reclamo.abierta).length;
    ...
    <Pantalla>
      <main id="contenido" className={estilos.pagina}>
        ...
        <NavDelVendedor
          ...
          {...(reclamosAbiertos > 0 ? { reclamos: reclamosAbiertos } : {})}
        />
            ...
            */}
            ...
            {visibles.length === 0 ? (
              <EstadoVacio titulo="Nada en esta pestaña">
                <p>
                  No hay ventas en este estado. Probá con <Link href="/vendedor/ventas">todas</Link>
                  .
                </p>
              </EstadoVacio>
            ) : (
