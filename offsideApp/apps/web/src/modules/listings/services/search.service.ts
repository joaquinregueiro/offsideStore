 ...
 *
 * ⚠️ SE EXPORTA porque la pantalla necesita el mismo numero para calcular
 * cuantas paginas hay. Repetir el 24 en `buscar/page.tsx` haria que el dia que
 * alguien lo cambie acá, la paginacion muestre una cantidad de paginas que no
 * existe.
 */
