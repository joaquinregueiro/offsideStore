...
/**
 * Lectura de `app_settings` (ERD §17.1) para las claves de reclamos. Sin
 * reglas de negocio.
 *
 ...
 * que ya duplican `orders` y `reputation` —"version vigente de una clave
 * global"—; cuando `config` exponga un `getSettingValue(key)` generico, este
 * archivo desaparece.
 */
