...
describe('constraints e integridad', () => {
  ...
  it('user_history_events es RESTRICT: protege los hechos del borrado del usuario', async () => {
     ...
     * (foreign_key_violation); PostgreSQL 18 la reporta como `23001`
     * (restrict_violation), que es el SQLSTATE que el estandar reserva para
     * eso. Clavar uno solo hacia que el test fallara al cambiar de version sin
     * que cambiara nada del esquema.
     */
